...
:: Check if finished
if "!AsciiCode:~%Counter%,9!" == "  {p8UyY}" goto :Finished
...
if "!AsciiCode:~%Counter%,1!" == "‘" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!82,& set DecimalCode=!DecimalCode!130,& set BinaryCode=!BinaryCode!10000010,
if "!AsciiCode:~%Counter%,1!" == "Ÿ" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!83,& set DecimalCode=!DecimalCode!131,& set BinaryCode=!BinaryCode!10000011,
if "!AsciiCode:~%Counter%,1!" == "“" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!84,& set DecimalCode=!DecimalCode!132,& set BinaryCode=!BinaryCode!10000100,
if "!AsciiCode:~%Counter%,1!" == "³" start msg %username% Unprintable ascii character: ³ & REM 133
if "!AsciiCode:~%Counter%,1!" == "Å" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!86,& set DecimalCode=!DecimalCode!134,& set BinaryCode=!BinaryCode!10000110,
if "!AsciiCode:~%Counter%,1!" == "Î" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!87,& set DecimalCode=!DecimalCode!135,& set BinaryCode=!BinaryCode!10000111,
if "!AsciiCode:~%Counter%,1!" == "´" start msg %username% Unprintable ascii character: ´ & REM 136
if "!AsciiCode:~%Counter%,1!" == "¹" start msg %username% Unprintable ascii character: ¹ & REM 137
if "!AsciiCode:~%Counter%,1!" == "º" start msg %username% Unprintable ascii character: º & REM 138
if "!AsciiCode:~%Counter%,1!" == "»" start msg %username% Unprintable ascii character: » & REM 139
if "!AsciiCode:~%Counter%,1!" == "¼" start msg %username% Unprintable ascii character: ¼ & REM 140
if "!AsciiCode:~%Counter%,1!" == "¿" start msg %username% Unprintable ascii character: ¿ & REM 141
if "!AsciiCode:~%Counter%,1!" == "À" start msg %username% Unprintable ascii character: À & REM 142
if "!AsciiCode:~%Counter%,1!" == "Á" start msg %username% Unprintable ascii character: Á & REM 143

if "!AsciiCode:~%Counter%,1!" == "Â" start msg %username% Unprintable ascii character: Â & REM 144
if "!AsciiCode:~%Counter%,1!" == "Ã" start msg %username% Unprintable ascii character: Ã & REM 145
if "!AsciiCode:~%Counter%,1!" == "Ä" start msg %username% Unprintable ascii character: Ä & REM 146
REM Missing Ascii Code 147 - relating to 134
if "!AsciiCode:~%Counter%,1!" == "È" start msg %username% Unprintable ascii character: È & REM 148
if "!AsciiCode:~%Counter%,1!" == "É" start msg %username% Unprintable ascii character: É & REM 149
if "!AsciiCode:~%Counter%,1!" == "Ê" start msg %username% Unprintable ascii character: Ê & REM 150
if "!AsciiCode:~%Counter%,1!" == "Ë" start msg %username% Unprintable ascii character: Ë & REM 151
if "!AsciiCode:~%Counter%,1!" == "Ì" start msg %username% Unprintable ascii character: Ì & REM 152
if "!AsciiCode:~%Counter%,1!" == "Í" start msg %username% Unprintable ascii character: Í & REM 153
REM Missing Ascii Code 154 - relating to 135
if "!AsciiCode:~%Counter%,1!" == "Ù" start msg %username% Unprintable ascii character: Ù & REM 155
if "!AsciiCode:~%Counter%,1!" == "Ú" start msg %username% Unprintable ascii character: Ú & REM 156
if "!AsciiCode:~%Counter%,1!" == "Û" start msg %username% Unprintable ascii character: Û & REM 157
if "!AsciiCode:~%Counter%,1!" == "Ü" start msg %username% Unprintable ascii character: Ü & REM 158
if "!AsciiCode:~%Counter%,1!" == "ß" start msg %username% Unprintable ascii character: ß & REM 159

if "!AsciiCode:~%Counter%,1!" == "ÿ" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!a0,& set DecimalCode=!DecimalCode!160,& set BinaryCode=!BinaryCode!10100000,
...
if "!AsciiCode:~%Counter%,1!" == "½" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!a2,& set DecimalCode=!DecimalCode!162,& set BinaryCode=!BinaryCode!10100010,
if "!AsciiCode:~%Counter%,1!" == "œ" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!a3,& set DecimalCode=!DecimalCode!163,& set BinaryCode=!BinaryCode!10100011,
if "!AsciiCode:~%Counter%,1!" == "Ï" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!a4,& set DecimalCode=!DecimalCode!164,& set BinaryCode=!BinaryCode!10100100,
if "!AsciiCode:~%Counter%,1!" == "¾" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!a5,& set DecimalCode=!DecimalCode!165,& set BinaryCode=!BinaryCode!10100101,
if "!AsciiCode:~%Counter%,1!" == "Ý" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!a6,& set DecimalCode=!DecimalCode!166,& set BinaryCode=!BinaryCode!10100110,
if "!AsciiCode:~%Counter%,1!" == "õ" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!a7,& set DecimalCode=!DecimalCode!167,& set BinaryCode=!BinaryCode!10100111,
if "!AsciiCode:~%Counter%,1!" == "ù" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!a8,& set DecimalCode=!DecimalCode!168,& set BinaryCode=!BinaryCode!10101000,
...
if "!AsciiCode:~%Counter%,1!" == "®" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!ab,& set DecimalCode=!DecimalCode!171,& set BinaryCode=!BinaryCode!10101011,
if "!AsciiCode:~%Counter%,1!" == "ª" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!ac,& set DecimalCode=!DecimalCode!172,& set BinaryCode=!BinaryCode!10101100,
if "!AsciiCode:~%Counter%,1!" == "ð" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!ad,& set DecimalCode=!DecimalCode!173,& set BinaryCode=!BinaryCode!10101101,
...
if "!AsciiCode:~%Counter%,1!" == "î" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!af,& set DecimalCode=!DecimalCode!175,& set BinaryCode=!BinaryCode!10101111,

if "!AsciiCode:~%Counter%,1!" == "ø" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!b0,& set DecimalCode=!DecimalCode!176,& set BinaryCode=!BinaryCode!10110000,
if "!AsciiCode:~%Counter%,1!" == "ñ" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!b1,& set DecimalCode=!DecimalCode!177,& set BinaryCode=!BinaryCode!10110001,
if "!AsciiCode:~%Counter%,1!" == "ý" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!b2,& set DecimalCode=!DecimalCode!178,& set BinaryCode=!BinaryCode!10110010,
if "!AsciiCode:~%Counter%,1!" == "ü" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!b3,& set DecimalCode=!DecimalCode!179,& set BinaryCode=!BinaryCode!10110011,
if "!AsciiCode:~%Counter%,1!" == "ï" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!b4,& set DecimalCode=!DecimalCode!180,& set BinaryCode=!BinaryCode!10110100,
if "!AsciiCode:~%Counter%,1!" == "æ" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!b5,& set DecimalCode=!DecimalCode!181,& set BinaryCode=!BinaryCode!10110101,
if "!AsciiCode:~%Counter%,1!" == "ô" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!b6,& set DecimalCode=!DecimalCode!182,& set BinaryCode=!BinaryCode!10110110,
if "!AsciiCode:~%Counter%,1!" == "ú" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!b7,& set DecimalCode=!DecimalCode!183,& set BinaryCode=!BinaryCode!10110111,
...
if "!AsciiCode:~%Counter%,1!" == "û" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!b9,& set DecimalCode=!DecimalCode!185,& set BinaryCode=!BinaryCode!10111001,
if "!AsciiCode:~%Counter%,1!" == "§" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!ba,& set DecimalCode=!DecimalCode!186,& set BinaryCode=!BinaryCode!10111010,
if "!AsciiCode:~%Counter%,1!" == "¯" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!bb,& set DecimalCode=!DecimalCode!187,& set BinaryCode=!BinaryCode!10111011,
...
if "!AsciiCode:~%Counter%,1!" == "ó" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!be,& set DecimalCode=!DecimalCode!190,& set BinaryCode=!BinaryCode!10111110,
...
if "!AsciiCode:~%Counter%,1!" == "Ç" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!c3,& set DecimalCode=!DecimalCode!195,& set BinaryCode=!BinaryCode!11000011,
if "!AsciiCode:~%Counter%,1!" == "Ž" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!c4,& set DecimalCode=!DecimalCode!196,& set BinaryCode=!BinaryCode!11000100,
if "!AsciiCode:~%Counter%,1!" == "" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!c5,& set DecimalCode=!DecimalCode!197,& set BinaryCode=!BinaryCode!11000101,
if "!AsciiCode:~%Counter%,1!" == "’" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!c6,& set DecimalCode=!DecimalCode!198,& set BinaryCode=!BinaryCode!11000110,
if "!AsciiCode:~%Counter%,1!" == "€" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!c7,& set DecimalCode=!DecimalCode!199,& set BinaryCode=!BinaryCode!11000111,
if "!AsciiCode:~%Counter%,1!" == "Ô" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!c8,& set DecimalCode=!DecimalCode!200,& set BinaryCode=!BinaryCode!11001000,
if "!AsciiCode:~%Counter%,1!" == "" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!c9,& set DecimalCode=!DecimalCode!201,& set BinaryCode=!BinaryCode!11001001,
if "!AsciiCode:~%Counter%,1!" == "Ò" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!ca,& set DecimalCode=!DecimalCode!202,& set BinaryCode=!BinaryCode!11001010,
if "!AsciiCode:~%Counter%,1!" == "Ó" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!cb,& set DecimalCode=!DecimalCode!203,& set BinaryCode=!BinaryCode!11001011,
if "!AsciiCode:~%Counter%,1!" == "Þ" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!cc,& set DecimalCode=!DecimalCode!204,& set BinaryCode=!BinaryCode!11001100,
if "!AsciiCode:~%Counter%,1!" == "Ö" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!cd,& set DecimalCode=!DecimalCode!205,& set BinaryCode=!BinaryCode!11001101,
...
if "!AsciiCode:~%Counter%,1!" == "Ø" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!cf,& set DecimalCode=!DecimalCode!207,& set BinaryCode=!BinaryCode!11001111,

if "!AsciiCode:~%Counter%,1!" == "Ñ" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!d0,& set DecimalCode=!DecimalCode!208,& set BinaryCode=!BinaryCode!11010000,
...
if "!AsciiCode:~%Counter%,1!" == "ã" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!d2,& set DecimalCode=!DecimalCode!210,& set BinaryCode=!BinaryCode!11010010,
if "!AsciiCode:~%Counter%,1!" == "à" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!d3,& set DecimalCode=!DecimalCode!211,& set BinaryCode=!BinaryCode!11010011,
if "!AsciiCode:~%Counter%,1!" == "â" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!d4,& set DecimalCode=!DecimalCode!212,& set BinaryCode=!BinaryCode!11010100,
if "!AsciiCode:~%Counter%,1!" == "å" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!d5,& set DecimalCode=!DecimalCode!213,& set BinaryCode=!BinaryCode!11010101,
if "!AsciiCode:~%Counter%,1!" == "™" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!d6,& set DecimalCode=!DecimalCode!214,& set BinaryCode=!BinaryCode!11010110,
if "!AsciiCode:~%Counter%,1!" == "ž" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!d7,& set DecimalCode=!DecimalCode!215,& set BinaryCode=!BinaryCode!11010111,
if "!AsciiCode:~%Counter%,1!" == "" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!d8,& set DecimalCode=!DecimalCode!216,& set BinaryCode=!BinaryCode!11011000,
if "!AsciiCode:~%Counter%,1!" == "ë" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!d9,& set DecimalCode=!DecimalCode!217,& set BinaryCode=!BinaryCode!11011001,
if "!AsciiCode:~%Counter%,1!" == "é" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!da,& set DecimalCode=!DecimalCode!218,& set BinaryCode=!BinaryCode!11011010,
if "!AsciiCode:~%Counter%,1!" == "ê" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!db,& set DecimalCode=!DecimalCode!219,& set BinaryCode=!BinaryCode!11011011,
if "!AsciiCode:~%Counter%,1!" == "š" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!dc,& set DecimalCode=!DecimalCode!220,& set BinaryCode=!BinaryCode!11011100,
if "!AsciiCode:~%Counter%,1!" == "í" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!dd,& set DecimalCode=!DecimalCode!221,& set BinaryCode=!BinaryCode!11011101,
if "!AsciiCode:~%Counter%,1!" == "è" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!de,& set DecimalCode=!DecimalCode!222,& set BinaryCode=!BinaryCode!11011110,
if "!AsciiCode:~%Counter%,1!" == "á" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!df,& set DecimalCode=!DecimalCode!223,& set BinaryCode=!BinaryCode!11011111,

if "!AsciiCode:~%Counter%,1!" == "…" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!e0,& set DecimalCode=!DecimalCode!224,& set BinaryCode=!BinaryCode!11100000,
if "!AsciiCode:~%Counter%,1!" == "þ" start msg %username% Unprintable ascii character: þ & REM 225
if "!AsciiCode:~%Counter%,1!" == "ƒ" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!e2,& set DecimalCode=!DecimalCode!226,& set BinaryCode=!BinaryCode!11100010,
if "!AsciiCode:~%Counter%,1!" == "Æ" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!e3,& set DecimalCode=!DecimalCode!227,& set BinaryCode=!BinaryCode!11100011,
if "!AsciiCode:~%Counter%,1!" == "„" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!e4,& set DecimalCode=!DecimalCode!228,& set BinaryCode=!BinaryCode!11100100,
if "!AsciiCode:~%Counter%,1!" == "†" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!e5,& set DecimalCode=!DecimalCode!229,& set BinaryCode=!BinaryCode!11100101,
if "!AsciiCode:~%Counter%,1!" == "‘" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!e6,& set DecimalCode=!DecimalCode!230,& set BinaryCode=!BinaryCode!11100110,
if "!AsciiCode:~%Counter%,1!" == "‡" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!e7,& set DecimalCode=!DecimalCode!231,& set BinaryCode=!BinaryCode!11100111,
if "!AsciiCode:~%Counter%,1!" == "Š" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!e8,& set DecimalCode=!DecimalCode!232,& set BinaryCode=!BinaryCode!11101000,
if "!AsciiCode:~%Counter%,1!" == "‘" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!e9,& set DecimalCode=!DecimalCode!233,& set BinaryCode=!BinaryCode!11101001,
if "!AsciiCode:~%Counter%,1!" == "ˆ" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!ea,& set DecimalCode=!DecimalCode!234,& set BinaryCode=!BinaryCode!11101010,
if "!AsciiCode:~%Counter%,1!" == "‰" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!eb,& set DecimalCode=!DecimalCode!235,& set BinaryCode=!BinaryCode!11101011,
if "!AsciiCode:~%Counter%,1!" == "" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!ec,& set DecimalCode=!DecimalCode!236,& set BinaryCode=!BinaryCode!11101100,
...
if "!AsciiCode:~%Counter%,1!" == "Œ" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!ee,& set DecimalCode=!DecimalCode!238,& set BinaryCode=!BinaryCode!11101110,
if "!AsciiCode:~%Counter%,1!" == "‹" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!ef,& set DecimalCode=!DecimalCode!239,& set BinaryCode=!BinaryCode!11101111,

if "!AsciiCode:~%Counter%,1!" == "Ð" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!f0,& set DecimalCode=!DecimalCode!240,& set BinaryCode=!BinaryCode!11110000,
...
if "!AsciiCode:~%Counter%,1!" == "•" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!f2,& set DecimalCode=!DecimalCode!242,& set BinaryCode=!BinaryCode!11110010,
...
if "!AsciiCode:~%Counter%,1!" == "“" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!f4,& set DecimalCode=!DecimalCode!244,& set BinaryCode=!BinaryCode!11110100,
if "!AsciiCode:~%Counter%,1!" == "ä" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!f5,& set DecimalCode=!DecimalCode!245,& set BinaryCode=!BinaryCode!11110101,
if "!AsciiCode:~%Counter%,1!" == "”" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!f6,& set DecimalCode=!DecimalCode!246,& set BinaryCode=!BinaryCode!11110110,
if "!AsciiCode:~%Counter%,1!" == "ö" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!f7,& set DecimalCode=!DecimalCode!247,& set BinaryCode=!BinaryCode!11110111,
if "!AsciiCode:~%Counter%,1!" == "›" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!f8,& set DecimalCode=!DecimalCode!248,& set BinaryCode=!BinaryCode!11111000,
if "!AsciiCode:~%Counter%,1!" == "—" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!f9,& set DecimalCode=!DecimalCode!249,& set BinaryCode=!BinaryCode!11111001,
...
if "!AsciiCode:~%Counter%,1!" == "–" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!fb,& set DecimalCode=!DecimalCode!251,& set BinaryCode=!BinaryCode!11111011,
if "!AsciiCode:~%Counter%,1!" == "" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!fc,& set DecimalCode=!DecimalCode!252,& set BinaryCode=!BinaryCode!11111100,
if "!AsciiCode:~%Counter%,1!" == "ì" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!fd,& set DecimalCode=!DecimalCode!253,& set BinaryCode=!BinaryCode!11111101,
if "!AsciiCode:~%Counter%,1!" == "ç" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!fe,& set DecimalCode=!DecimalCode!254,& set BinaryCode=!BinaryCode!11111110,
if "!AsciiCode:~%Counter%,1!" == "˜" set /a Counter=%Counter% + 1 & set HexCode=!HexCode!ff,& set DecimalCode=!DecimalCode!255,& set BinaryCode=!BinaryCode!11111111,
...
set AsciiCode=!AsciiCode:´=!
set AsciiCode=!AsciiCode:¹=!
set AsciiCode=!AsciiCode:º=!
set AsciiCode=!AsciiCode:»=!
set AsciiCode=!AsciiCode:¼=!
set AsciiCode=!AsciiCode:¿=!
set AsciiCode=!AsciiCode:À=!
set AsciiCode=!AsciiCode:Á=!
set AsciiCode=!AsciiCode:Â=!
set AsciiCode=!AsciiCode:Ã=!
set AsciiCode=!AsciiCode:Ä=!
set AsciiCode=!AsciiCode:È=!
set AsciiCode=!AsciiCode:É=!
set AsciiCode=!AsciiCode:Ê=!
set AsciiCode=!AsciiCode:Ë=!
set AsciiCode=!AsciiCode:Ì=!
set AsciiCode=!AsciiCode:Í=!
set AsciiCode=!AsciiCode:Ù=!
set AsciiCode=!AsciiCode:Ú=!
set AsciiCode=!AsciiCode:Û=!
set AsciiCode=!AsciiCode:Ü=!
set AsciiCode=!AsciiCode:ß=!
set AsciiCode=!AsciiCode:þ=!
set AsciiCode=%AsciiCode:!=%


echo Ascii: !AsciiCode! 1>Ascii2All.tmp
echo Hex:   !HexCode! 1>>Ascii2All.tmp
echo Dec:   !DecimalCode! 1>>Ascii2All.tmp
echo Bin:   !BinaryCode! 1>>Ascii2All.tmp
start notepad "%temp%\Ascii2All.tmp"
echo Hex:   !HexCode!
